...
public class Api : WebApplication<ECommerce.Checkout.API.Program>, IApi, IAsyncLifetime
{
    public Api() : base(new WebApplicationFactory<ECommerce.Checkout.API.Program>())
    { }
    ...
    protected override WebApplicationFactory<ECommerce.Checkout.API.Program> CustomWebApplicationFactory()
    {
